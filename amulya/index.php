...
if(isset($_POST['quiryname'])){ 
   ...
   $sql = "INSERT INTO `infinityhomes`.`amulyaquiry` (`quiryname`, `quiryemail`, `quiryphone`) VALUES ('$name', '$email', '$phone')";
   

   if($con->query($sql) == true){
    header("Location: http://localhost/amulya/thanku.html");
     exit();
}
else{
...
$con->close();
   ...
   if(isset($_POST['visitname'])){
    ...
    $sql = "INSERT INTO `infinityhomes`.`amulyavisit` (`visitname`, `visitemail`, `visitphone`) VALUES ('$name', '$email', '$phone')";
              ...
              <div class="w3-col l12">
                <div class="content_box">
                  <div class="img_box layout-box">
                    <img src="images/layout.png" class="w-100" alt="..." />
                  </div>
